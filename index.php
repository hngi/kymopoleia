        ...
        <div class="main">
            <header>
                ...
                <div id="nav-div" class="nav-div">
                    <p> <a href="index.php" class="active"> Home</a>
                        <a href=""> About</a>
            ...
            <div class="center">
                   <h1>BUDGET YOUR FINANCES WITH US</h1>
                   <p>We make the riogorous process of budget ctreation as easy as ABC</p>
                   <p><a href="#" id="link">How it works</a></p>
